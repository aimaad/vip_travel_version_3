...
<div class="header-widgets d-flex flex-grow-1">
    <div class="widgets-left d-flex flex-grow-1 align-items-center">
        ...
        <div class="header-widget search-widget" >
            ...
            <a  style="color: white;" href="<?php echo e(url('/')); ?>" class="btn btn-link" target="_blank"><i class="fa fa-eye"></i> <?php echo e(__('Home')); ?>
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
            ...
            <a href="<?php echo e(url('/admin/module/tour/create')); ?>" class="btn btn-primary" style="background: #1a2b48;border:#1a2b48;"><?php echo e(__('Add New Tour')); ?></a>
        </div>
                ...
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($locale == $language->locale): ?>
                        <div class="user-info flex-grow-1 d-flex">
                            ...
                            <?php endif; ?>
                            <span style="color: white " ><?php echo e($language->name); ?></span>
                        </div>
                    <?php endif; ?>
        ...
        <div class="dropdown header-widget widget-user flex-shrink-0">
            <div data-toggle="dropdown" class="user-dropdown d-flex align-items-center" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="user-info flex-grow-1">
                    <div class="user-name" style="color: white"><?php echo e($user->getDisplayName()); ?></div>
                    <div class="user-role" style="color: #1a2b48"><?php echo e(ucfirst($user->role->name ?? '')); ?></div>
                </div>
                <i class="fa fa-angle-down" style="color: white"></i>
            </div>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>