...
<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="form-group input-with-icon">
        <label for="term">
            <input id="<?php echo e($uniqueID_register); ?>" type="checkbox" name="term" class="mr5">
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>