    ...
    <div class="form-group input-with-icon">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="<?php echo e($uniqueID); ?>" value="1"> <?php echo e(__('Remember me')); ?> <span class="checkmark fcheckbox"></span>
            </label>
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\modules/Layout/auth/login-form.blade.php ENDPATH**/ ?>