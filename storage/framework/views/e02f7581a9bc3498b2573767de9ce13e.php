...
?>
<ul class="main-menu pb-5" style="background: #5467a6;">
    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group_id=>$group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!empty($group['name'])): ?>
            <li class="group mt-3 pos-<?php echo e($group['position'] ?? 0); ?>">
                <span class="group-name  d-flex align-items-center justify-content-between "  style="color: #1a2b48"><?php echo e($group['name']); ?>

                    <?php if($require_pro): ?>
                        <a style="color: white" href="#" <?php if(!isPro()): ?> data-toggle="modal" data-target="#upgrade-pro" <?php else: ?> title="Pro feature" <?php endif; ?> class="">
        ...
        <?php $menuItem['class'] .= " ".str_ireplace("/","_",$menuItem['url']) ?>
            <li class="menu-item pos-<?php echo e($menuItem['position'] ?? 0); ?> <?php echo e($menuItem['class']); ?>">
                <a style="color: white" href="<?php echo e(url($menuItem['url'])); ?>">
                <?php if(!empty($menuItem['icon'])): ?>
                    <span class="icon text-center"><i style="color: white" class="<?php echo e($menuItem['icon']); ?>"></i></span>
                <?php endif; ?>
            ...
            <?php if(!empty($menuItem['children'])): ?>
                <span class="btn-toggle"><i class="fa fa-angle-left pull-right" style="color: white"></i></span>
                <ul class="children">
                    <?php $__currentLoopData = $menuItem['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="<?php echo e($menuItem['class']); ?>"><a  style="color: white" href="<?php echo e(url($menuItem2['url'])); ?>">
                                <?php if(!empty($menuItem2['icon'])): ?>
                                    <i class="<?php echo e($menuItem2['icon']); ?>" style="color: white"></i>
                                <?php endif; ?>
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\modules/Layout/admin/parts/sidebar.blade.php ENDPATH**/ ?>