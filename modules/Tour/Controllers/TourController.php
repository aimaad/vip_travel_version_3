<?php
    ...
    class TourController extends Controller
    {
        ...
        public function __construct(Tour $tour , Location $location , TourCategory $tour_category , Attributes $attributes , LocationCategory $location_category)
        {
            $this->tourClass = $tour;
            $this->locationClass = $location;
            $this->tourCategoryClass = $tour_category;
