...
// Check if the user is not already an agent
if ($dataUser->role_id !== 4) {  // 4 is the role_id for 'Agent de voyage'
    $menus['become-agent'] = [
        'url' => route('user.becomeAgentForm', $dataUser->id),
...
// Check if the user is not already a distributor
if ($dataUser->role_id !== 5) {  // 5 is the role_id for 'Distributeur de voyage'
    $menus['become-distributor'] = [
        'url' => route('user.becomeDistributorForm', $dataUser->id),
        'title' => __("Become a Distributor"),
...
<div class="sidebar-user">
    ...
    <div class="logout">
        <a href="{{url('/')}}" style="color: #a3aadd;"><i class="fa fa-long-arrow-left"></i> {{__("Back to Homepage")}}</a>
    </div>
</div>
