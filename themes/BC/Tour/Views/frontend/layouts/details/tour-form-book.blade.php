<div class="bravo_single_book_wrap @if(setting_item('tour_enable_inbox')) has-vendor-box @endif">
    <div class="bravo_single_book">
        <div id="bravo_tour_book_app" v-cloak  data-tour-date="{{ $tour_date }}" data-tour-date-html="{{ \Carbon\Carbon::parse($tour_date)->format('F j, Y') }}"> 
                    ...
                    <div class="form-group form-date-field form-date-search clearfix " data-format="{{get_moment_date_format()}}">
                        ...
                        <div >
                            <div style="text-align: center;" >
                                <label><h4>{{__("Start Date")}}</h4></label>
                                <div class="render check-in-render"><h5>{{ $tour_date }}</h5></div>
                            </div>
